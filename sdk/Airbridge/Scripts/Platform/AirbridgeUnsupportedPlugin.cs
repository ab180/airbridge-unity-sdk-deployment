...
internal class AirbridgeUnsupportedPlugin: IAirbridgePlugin
{
    ...
    public void BlockTrackingItem(AirbridgeTrackingBlocklist item) { UnsupportedPlatform(); }
    
    public void AllowTrackingItem(AirbridgeTrackingBlocklist item) { UnsupportedPlatform(); }
