...
import static co.ab180.airbridge.unity.AirbridgeCallback.NO_ARG;
...
public class AirbridgeUnity {
    ...
    public static void click(@NotNull String trackingLink, AirbridgeCallback onSuccess, AirbridgeCallback onFailure) {
        try {
            Airbridge.click(
                    ...
                    unit -> {
                        if (onSuccess != null) onSuccess.Invoke(NO_ARG);
                    },
                    throwable -> {
    ...
    public static void blockTrackingItem(String str) {
        try {
            AirbridgeTrackingBlocklist item = AirbridgeUtils.stringToAirbridgeTrackingBlocklist(str);
            if (item != null) {
                Airbridge.blockTrackingItem(item);
            }
        } catch (Throwable throwable) {
            Log.e(TAG, "Error occurs while calling {blockTrackingItem}", throwable);
        }
    }

    public static void allowTrackingItem(String str) {
        try {
            AirbridgeTrackingBlocklist item = AirbridgeUtils.stringToAirbridgeTrackingBlocklist(str);
            if (item != null) {
            ...
            Log.e(TAG, "Error occurs while calling {allowTrackingItem}", throwable);
        }
    }
    ...
    private static void processHandleDeferredDeeplink() {
        try {
            Airbridge.handleDeferredDeeplink(/* Nullable */ uri -> {
                if ((uri != null) && (deeplinkCallback != null)) {
                    handleDeeplinkOnSuccess(uri.toString());
                }
            });
        } catch (Throwable throwable) {
    ...
    private static void unitySendAttributionResult() {
        if ((attributionResultCallback != null) && (receivedAttributionResult != null)) {
